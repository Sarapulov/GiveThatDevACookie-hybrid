...
angular.module('GiveThatDevACookie.services', ['ngResource'])
.constant("baseURL", "https://givethatdevacookie.herokuapp.com/")

// .constant("baseURL", "https://192.168.178.28:3443/")
...
// [OK]
.factory('shareAppFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
  return $resource(baseURL + "apps", null, {
      'create': {
          method: 'POST'
      }
  });
...
.factory('commentFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
  return $resource(baseURL + "apps/:id/comments/:commentId", {id:"@Id", commentId: "@CommentId"}, {
        'update': {
            method: 'PUT'
        }
    });
